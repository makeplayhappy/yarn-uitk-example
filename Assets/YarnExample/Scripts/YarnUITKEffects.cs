...
namespace Yarn.Unity
{
    ...
    /// </summary>
    public static class YarnUITKEffects
    {
        /// <summary>
        ...
        public static IEnumerator FadeAlpha(VisualElement canvasGroup, float from, float to, float fadeTime, CoroutineInterruptToken stopToken = null)
        {
            stopToken?.Start();

            //canvasGroup.alpha = from;
            canvasGroup.style.opacity = from;
            ...
            while (timeElapsed < fadeTime)
            {
                ...
                //canvasGroup.alpha = a;
                canvasGroup.style.opacity = a;
                yield return null;
            }

            //canvasGroup.alpha = to;
            canvasGroup.style.opacity = to;
            ...
            if (to == 0)
            {
                ...
                //canvasGroup.pickingMode = PickingMode.Ignore; //could also display: none ...?
                canvasGroup.style.display = DisplayStyle.None;
            }
            else
            {
                ...
                //canvasGroup.pickingMode = PickingMode.Position;
                canvasGroup.style.display = DisplayStyle.Flex; 
            }
        ...
        /// <param name="stopToken">A <see cref="CoroutineInterruptToken"/> that
        /// can be used to interrupt the coroutine.</param>
        public static IEnumerator Typewriter(TypewriterLabel text, float lettersPerSecond, Action onCharacterTyped, CoroutineInterruptToken stopToken = null)
        {
            stopToken?.Start();
